...
inline void opt::fr::Tile::intializeVertexes()
{
...
inline opt::fr::Tile::Tile() : m_texture{ nullptr }, m_numberSubTexture{ 0 }, m_textureRule{ TextureRule::repeat_texture }, m_subTextures{ nullptr }
{}

inline opt::fr::Tile::Tile(const sf::Texture& texture, int noTuileDebutTexture, const sf::Vector2f& desiredSize,
...
inline float opt::fr::Tile::height() const
{
	return m_tileSize.y;
}

inline float opt::fr::Tile::width() const
{
	return m_tileSize.x;
}

inline const std::vector<sf::Vertex>& opt::fr::Tile::vertexes() const
{
	return m_vertexes;
}

inline std::vector<sf::Vertex>& opt::fr::Tile::vertexes()
{
	return m_vertexes;
}

inline sf::Vector2f opt::fr::Tile::topLeftCorner() const
{
	return m_position;
}

inline sf::Vector2f opt::fr::Tile::topRightCorner() const
{
	return m_position + sf::Vector2f(this->width(), 0.f);
}

inline sf::Vector2f opt::fr::Tile::bottomLeftCorner() const
{
	return m_position + sf::Vector2f(0.f, this->height());
}

inline sf::Vector2f opt::fr::Tile::bottomRightCorner() const
{
	return m_position + this->m_tileSize;
}

inline sf::Vector2f opt::fr::Tile::getPosition() const
{
	return topLeftCorner();
}

inline void opt::fr::Tile::setScale(const sf::Vector2f& scale)
{
...
inline void opt::fr::Tile::setScale(float scale)
{
	switch (m_textureRule)
	{
	case TextureRule::keep_height:
...
inline void opt::fr::Tile::setScale(float x, float y)
{
	switch (m_textureRule)
	{
	case TextureRule::repeat_texture:
...
inline void opt::fr::Tile::setScale(const sf::Vector2f& scale, TextureRule textureRule)
{
	m_textureRule = textureRule;
	setScale(scale);
}

inline void opt::fr::Tile::setScale(float scale, TextureRule textureRule)
{
	m_textureRule = textureRule;
	setScale(scale);
}

inline void opt::fr::Tile::setScale(float x, float y, TextureRule textureRule)
{
	m_textureRule = textureRule;
	setScale(x, y);
}

inline void opt::fr::Tile::resize(const sf::Vector2f& size)
{
	float scale{};
	switch (m_textureRule)
	{
...
inline void opt::fr::Tile::resize(float x, float y)
{
	float scale{};
	switch (m_textureRule)
	{
...
inline void opt::fr::Tile::resize(const sf::Vector2f& size, TextureRule textureRule)
{
	m_textureRule = textureRule;
	resize(size);
}

inline void opt::fr::Tile::resize(float x, float y, TextureRule textureRule)
{
	m_textureRule = textureRule;
	resize(x, y);
}

inline void opt::fr::Tile::changeTextureRect(int numberSubTexture)
{
...
inline void opt::fr::Tile::setTextureRule(TextureRule textureRule)
{
	m_textureRule = textureRule;
}

inline opt::fr::TextureRule opt::fr::Tile::getTextureRule()
{
	return m_textureRule;
}

inline void opt::fr::Tile::move(const sf::Vector2f& offset)
{
	for (auto& sommet : m_vertexes)
		sommet.position += offset;
}

inline void opt::fr::Tile::move(float offsetX, float offsetY)
{
...
inline void opt::fr::Tile::setPosition(const sf::Vector2f& position)
{
...
inline void opt::fr::Tile::setPosition(float x, float y)
{
...
inline void opt::fr::Tile::reloadTexture()
{
...
inline opt::fr::Tile* opt::fr::Tile::getThis()
{
	return this;
}

inline std::unique_ptr<opt::fr::Tile> opt::fr::Tile::clone() const
{
	return std::make_unique<opt::fr::Tile>(*this);
}

inline float opt::fr::Tile::subTextureHeight() const
{
	return m_subTextures->at(m_numberSubTexture).height;
}

inline float opt::fr::Tile::subTextureWidth() const
{
	return m_subTextures->at(m_numberSubTexture).width;
}

inline sf::Vector2f opt::fr::Tile::subTextureSize() const
{
	return sf::Vector2f(m_subTextures->at(m_numberSubTexture).width, m_subTextures->at(m_numberSubTexture).height);
}

inline void opt::fr::Tile::changeColor(const sf::Color& color)
{
	m_color = color;
	for (auto& sommet : m_vertexes)
		sommet.color = m_color;
...
inline void opt::fr::Tile::resetColor()
{
...
inline sf::Color opt::fr::Tile::getColor() const
{
	return m_color;
}

inline sf::Vector2f opt::fr::Tile::getSize() const
{
	return m_tileSize;
}

inline int opt::fr::Tile::subTextureIndex() const
{
